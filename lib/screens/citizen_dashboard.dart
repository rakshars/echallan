              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const ReportViolationScreen()),
                    );
                  },
                  child: Container(
                    padding: const EdgeInsets.all(20),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.camera_alt_outlined, color: Color(0xFF3B82F6), size: 32),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Upload Violation Report', style: GoogleFonts.poppins(color: const Color(0xFF1F2937), fontWeight: FontWeight.bold, fontSize: 16)),
                              const SizedBox(height: 4),
                              Text('Report overspeeding or parking issues', style: GoogleFonts.inter(color: const Color(0xFF6B7280), fontSize: 12)),
                            ],
                          ),
                        ),
                ...
                if (_userId.isNotEmpty)
                  FutureBuilder<List<Map<String, dynamic>>>(
                    future: _dbService.getUserViolations(_userId),
